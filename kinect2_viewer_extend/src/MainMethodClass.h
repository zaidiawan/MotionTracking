...
public:
    /*void run(cv::Mat& image,cv::Mat& depthImage,IplImage* depthIplImage,cv::Mat& originalColorImage,cv::Mat& originalDepthImage,
        OpenCVKinect& openCVKinect,IplImage* edgeDepthImage,float frameRate);*/
    void run(cv::Mat& colorImageOrgSize,cv::Mat& depthImageOrgSize,
...
private:
    ...
    // Color + Depth Hand Tracking Methods
    /*void trackLeftHand(Mat& image,cv::Mat& depthImage,IplImage* depthIplImage,cv::Mat& originalColorImage,
        cv::Mat& originalDepthImage,OpenCVKinect& openCVKinect,IplImage* edgeDepthImage);*/

    void trackLeftHand(Point3i& handCoordinates);

    /*void trackRightHand(Mat& image,cv::Mat& depthImage,IplImage* depthIplImage,cv::Mat& originalColorImage,cv::Mat& originalDepthImage,
    ...
    void deflicker(IplImage* Mat1,int strengthcutoff);
